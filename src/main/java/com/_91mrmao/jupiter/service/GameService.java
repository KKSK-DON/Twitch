...
import com._91mrmao.jupiter.entity.response.Game;
...
public class GameService {
    private static final String TOKEN = "Bearer 1mbnzf6o32asz7g04a632oz91l3feg";
    private static final String CLIENT_ID = "fn7mcv68p02rrlkdu0kft6txg8qnjt";
...
//
    ...
    // Send HTTP requests to Twitch Backend based on the given URL, and returns the body of the HTTP response returned from Twitch backend.
    // searchTwitch return data 的 json code
    ...
    public List<Game> topGames(int limit){
        ...
        String jsonString = searchTwitch(gameURL);
        return getGameList(jsonString);
    }
    ...
    private List<Item> searchStreams(String gameId, int limit) throws TwitchException {
        ...
        for (Item item : streams) {
            ...
            //原本的type 和我们要的不一样
            // itemtype 也要写 jsonproperty 因为再传到前端会需要这个
...
//        约等于
//        if (type == ItemType.CLIP){
//
//        } else if (type == ItemType.STREAM) {
//
